...
type FrameTransformFn = (
    arg0: VideoFrame,
    args1: TransformStreamDefaultController<VideoFrame>
) => Promise<void>;
 ...
 *
 */
export function createProcessedMediaStreamTrack(
    sourceTrack: MediaStreamVideoTrack,
    transform: FrameTransformFn,
    signal: AbortSignal
) {
 ...
 * MediaStream.
 */
export function createProcessedMediaStream(
